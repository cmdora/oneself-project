    ...
    <div class="card">
        <div class="card-header" align="center">
            <form class="form-inline" @submit.prevent>
                <input class="form-control form-control-lg wide" v-model="searchInput" type="text" @keyup.enter="searchMp(1)" placeholder="搜索公众号/文章">
        ...
        <div class="card card-block text-xs-right" v-if="hasNextPage && searchResultJson && !isSearching">
          <h5 class="btn btn-outline-success btn-block" @click="searchMp(page)">
            下一页 ({{page}}) <i class="fa fa-angle-double-right"></i>
          </h5>
        </div>
    ...
    export default {
      ...
      methods: {
        ...
        subscribe (idx) {
          ...
          // this.mpList[idx].isSubscribe = true
        }
      }
    }
</script>
